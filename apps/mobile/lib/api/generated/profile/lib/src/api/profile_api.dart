...
class ProfileApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetCustomerAvatar200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerAvatar200Response>> getCustomerAvatar({ 
    ...
    final _path = r'/profile/customer/{user_id}/avatar'.replaceAll('{' r'user_id' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    ...
    GetCustomerAvatar200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCustomerAvatar200Response),
      ) as GetCustomerAvatar200Response;
    ...
    return Response<GetCustomerAvatar200Response>(
      data: _responseData,
  ...
  /// Returns a short-lived presigned GET URL for the stored avatar. Read auth is **owner-or-admin**. 404 when no avatar is set or the guard has no profile. 
  ///
  /// Parameters:
  /// * [userId] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetGuardAvatar200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetGuardAvatar200Response>> getGuardAvatar({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/profile/guard/{user_id}/avatar'.replaceAll('{' r'user_id' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetGuardAvatar200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetGuardAvatar200Response),
      ) as GetGuardAvatar200Response;
    ...
    return Response<GetGuardAvatar200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Upload/replace the customer&#39;s avatar (JPEG/PNG/WEBP, ≤10 MiB). The MIRROR of &#x60;POST /profile/guard/{user_id}/avatar&#x60; for the customer side. Auth: logged-in **customer, own avatar only** (&#x60;{user_id}&#x60; must equal the caller — no admin bypass on write). Image is magic-byte validated (declared MIME must match the content), stored in private S3 under a server-generated key, and the key written to &#x60;customer_profiles.avatar_key&#x60;. Returns a short-lived (1h) presigned GET URL — the raw key is never exposed. 
  ///
  /// Parameters:
  /// * [userId] - The customer's user_id (must equal the caller).
  /// * [file] - The avatar image (JPEG/PNG/WEBP, ≤10 MiB).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [GetCustomerAvatar200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerAvatar200Response>> uploadCustomerAvatar({ 
    required String userId,
  ...
  /// Upload/replace the guard&#39;s avatar (JPEG/PNG/WEBP, ≤10 MiB). Auth: logged-in **guard, own avatar only** (&#x60;{user_id}&#x60; must equal the caller — no admin bypass on write). Image is magic-byte validated (declared MIME must match the content), stored in private S3 under a server-generated key, and the key written to &#x60;avatar_key&#x60;. Returns a short-lived (1h) presigned GET URL — the raw key is never exposed. 
  ///
  /// Parameters:
  ...
  /// Returns a [Future] containing a [Response] with a [GetGuardAvatar200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetGuardAvatar200Response>> uploadGuardAvatar({ 
    required String userId,
    required MultipartFile file,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Upserts the caller&#39;s customer profile (minimal in this slice: full name + address). **Dual auth** (either satisfies the request):   - a single-use &#x60;profileToken&#x60; (&#x60;customer_profile&#x60;) from registration (the user is     not logged in yet); consumed single-use, and a &#x60;guard_profile&#x60; token is rejected     here (purpose isolation).   - a logged-in customer&#39;s &#x60;bearerAuth&#x60; access token (a later self-edit), role-gated.  Writes ONLY the customer profile schema; identity&#39;s approval state is never written directly. The new row starts &#x60;pending&#x60; and emits NO event: **customers are now admin-approved exactly like guards** — a reviewer approves/rejects them via &#x60;POST /admin/customer-profiles/{user_id}/{approve,reject}&#x60;, which emits &#x60;user.approved&#x60; so identity unblocks login. The fields in this minimal slice are optional, so \&quot;submission\&quot; — not field completeness — is the gate (the official client makes &#x60;address&#x60; required). A later self-edit re-upsert leaves the approval decision untouched. 
  ///
  /// Parameters:
