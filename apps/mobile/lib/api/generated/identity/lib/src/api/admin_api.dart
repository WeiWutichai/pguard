...
class AdminApi {
  ...
  /// Creates a long-lived admin API token for the CALLER. **Admin only** (else &#x60;403&#x60;). Returns the FULL token &#x60;pguard_&lt;prefix&gt;_&lt;secret&gt;&#x60; **exactly once** — only the SHA-256 hash of the secret is stored, so it can never be shown again. The token authenticates as the creator&#39;s role (admin) and is usable as a &#x60;Bearer&#x60; for admin API calls (the gateway validates it via identity&#39;s internal verify endpoint and injects the trusted user). Revoke via DELETE. 
  ///
  /// Parameters:
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateApiToken200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateApiToken200Response>> createApiToken({ 
    required CreateApiTokenRequest createApiTokenRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/api-tokens';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateApiTokenRequest);
      _bodyData = _serializers.serialize(createApiTokenRequest, specifiedType: _type);
    ...
    CreateApiToken200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateApiToken200Response),
      ) as CreateApiToken200Response;
    ...
    return Response<CreateApiToken200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Lists the CALLER&#39;S admin API tokens — &#x60;{ id, name, prefix, role, created_at, last_used_at, revoked }&#x60;. **Admin only**. The secret is NEVER returned (only the public prefix). A revoked token is still listed (audit) but cannot authenticate. 
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListApiTokens200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListApiTokens200Response>> listApiTokens({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    ListApiTokens200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListApiTokens200Response),
      ) as ListApiTokens200Response;
    ...
    return Response<ListApiTokens200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Soft-revokes ONE of the caller&#39;s OWN admin API tokens by id. **Admin only** + ownership-scoped (a token that isn&#39;t theirs → &#x60;404&#x60;, IDOR-safe). The row is kept for audit; a revoked token fails verification immediately. 
  ///
  /// Parameters:
  /// * [id] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InlineObject>> revokeApiToken({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/api-tokens/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
