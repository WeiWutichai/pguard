...
///
/// Properties:
/// * [currentPassword] - SHA-256 hex of the CURRENT PIN (same shape/value as login's `password`). Verified server-side; a wrong value → a generic 401 (no enumeration). 
...
abstract class ChangePasswordRequest implements Built<ChangePasswordRequest, ChangePasswordRequestBuilder> {
  /// SHA-256 hex of the CURRENT PIN (same shape/value as login's `password`). Verified server-side; a wrong value → a generic 401 (no enumeration). 
