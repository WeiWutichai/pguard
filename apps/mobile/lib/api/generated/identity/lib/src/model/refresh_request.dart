...
///
/// Properties:
/// * [refreshToken] - The opaque refresh token (`{rotation_id}.{secret}`). May be omitted if the `refresh_token` cookie is present. 
@BuiltValue()
abstract class RefreshRequest implements Built<RefreshRequest, RefreshRequestBuilder> {
  /// The opaque refresh token (`{rotation_id}.{secret}`). May be omitted if the `refresh_token` cookie is present. 
