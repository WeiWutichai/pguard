...
class InternalApi {
  ...
  /// Resolve a batch of &#x60;user_id&#x60;s to &#x60;{ role, display_name, phone }&#x60; for an internal caller. This is identity&#39;s OWN schema, so it answers EVERY role — including ADMINS, who have no profile row (the gap that left admin names blank on the web admin lists / Activity Log #142). The profile service&#39;s &#x60;POST /admin/users/resolve&#x60; resolves guard/customer locally, then calls this for the still-unresolved ids and merges admin names in.  &#x60;phone&#x60; is the account&#39;s LOGIN number (&#x60;identity.users.phone&#x60;) — what the person registered and signs in with. profile surfaces it on its admin list rows as &#x60;login_phone&#x60;, because an applicant who skipped the optional profile fields is otherwise unidentifiable in the approval queue. It is NOT a customer profile&#39;s optional &#x60;contact_phone&#x60;.  **Requires a service-JWT** (&#x60;serviceAuth&#x60;, audience &#x60;pguard-internal&#x60;); blocked at the public gateway (&#x60;/internal/&#x60;). Returns a MAP keyed by id; unknown/deleted ids are OMITTED. &#x60;role&#x60; + &#x60;display_name&#x60; + &#x60;phone&#x60; ONLY — still NEVER email or any other PII, and &#x60;phone&#x60; is admin-surface material: never log it or return it on a non-admin path. Bounded to 500 ids (a larger batch → 400). 
  ///
  /// Parameters:
  /// * [resolveUsersRequest] 
