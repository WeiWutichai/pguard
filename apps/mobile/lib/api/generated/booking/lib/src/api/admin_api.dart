...
class AdminApi {
  ...
  /// The \&quot;งานตามประเภทบริการ\&quot; / bookings-by-service-type breakdown (#140) over &#x60;[from, to)&#x60; keyed on &#x60;created_at&#x60;: per catalog service, the booking &#x60;count&#x60; (all statuses) and gross &#x60;revenue&#x60; (&#x60;Σ base_fee × hours × guard_count + tip&#x60; over non-cancelled/declined bookings). Bookings placed WITHOUT picking a catalog service collapse into a single \&quot;unspecified\&quot; bucket (&#x60;service_id&#x60; / names null) so untyped jobs are shown, not dropped. Defaults to the last 30 days (capped at 366). &#x60;total&#x60; &#x3D; Σ of all rows&#39; counts. Admin only (else 403). 
  ///
  /// Parameters:
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminBookingsByServiceReport200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminBookingsByServiceReport200Response>> adminBookingsByServiceReport({ 
    DateTime? from,
    DateTime? to,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/admin/reports/bookings-by-service';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AdminBookingsByServiceReport200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminBookingsByServiceReport200Response),
      ) as AdminBookingsByServiceReport200Response;
    ...
    return Response<AdminBookingsByServiceReport200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Composite booking analytics over &#x60;[from, to)&#x60; in one round-trip: daily booking-volume series, a guard-hours heatmap (day-of-week × 2-hour bucket of scheduled time), and an aggregate customer-retention curve. Defaults to the last 30 days (capped at 366). Admin only (else 403). NOTE: a bookings-BY-SERVICE-TYPE breakdown is NOT included — the booking model has no service_type dimension in v2 (it would entail the deferred catalog→charge integration decision). 
  ///
  /// Parameters:
  /// * [from] - Inclusive window start (RFC3339). Default = `to − 30 days`.
  /// * [to] - Exclusive window end (RFC3339). Default = now.
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminBookingsReport200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminBookingsReport200Response>> adminBookingsReport({ 
    DateTime? from,
    DateTime? to,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/admin/reports/bookings';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AdminBookingsReport200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminBookingsReport200Response),
      ) as AdminBookingsReport200Response;
    ...
    return Response<AdminBookingsReport200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InlineObject1>> adminCreateService({ 
    ...
    final _path = r'/admin/pricing/services';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Sets &#x60;is_active &#x3D; false&#x60; (history preserved). Returns the updated row.
  ///
  /// Parameters:
  /// * [id] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future] containing a [Response] with a [InlineObject1] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InlineObject1>> adminDeleteService({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/pricing/services/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Admin-managed catalog of bookable service types with a base rate. STANDALONE — the charge path is not wired to this catalog yet (bookings keep their server-owned base_fee). Active-first, newest next. Admin only (else 403). 
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminListServices200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminListServices200Response>> adminListServices({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    AdminListServices200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminListServices200Response),
      ) as AdminListServices200Response;
  ...
  /// Returns a [Future] containing a [Response] with a [InlineObject1] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InlineObject1>> adminUpdateService({ 
    required String id,
