...
class BookingsApi {
  ...
  /// A guard accepts → status &#x60;accepted&#x60;, &#x60;guard_id&#x60; set to the caller. Enqueues &#x60;pguard.events.booking.job_accepted&#x60; &#x60;{ booking_id, customer_id, guard_id }&#x60; into the outbox in the SAME transaction (transactional outbox). Rejected with 409 if the booking is not in a state from which acceptance is legal. 
  ///
  /// Parameters:
  /// * [id] 
  ...
  /// A customer creates a booking request (status &#x60;requested&#x60;). Role gating is enforced in the handler (403 for non-customers). No event is emitted for a bare request. 
  ///
  /// Parameters:
