...
class FCMTokensApi {
  ...
  Future<Response<InlineObject>> registerToken({ 
    required RegisterTokenRequest registerTokenRequest,
    ...
    try {
      const _type = FullType(RegisterTokenRequest);
      _bodyData = _serializers.serialize(registerTokenRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [InlineObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InlineObject>> unregisterToken({ 
    required DeleteTokenRequest deleteTokenRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(DeleteTokenRequest);
      _bodyData = _serializers.serialize(deleteTokenRequest, specifiedType: _type);
