...
void main() {
  testWidgets('renders a card for each role (customer + guard)', (tester) async {
    ...
    expect(find.textContaining('ลูกค้า · Customer'), findsOneWidget);
    expect(find.textContaining('เจ้าหน้าที่ รปภ. · Security guard'),
        findsOneWidget);
