...
**Verify (Definition of Done):** `cargo build --workspace` ✅ · `cargo clippy --workspace --all-targets -D warnings` ✅ · `cargo test --workspace` ✅ **221 passed/0 failed** (api-gateway 54 · profile 26 · otp 42 · identity 25 · booking 18 · notification 16 · shared 35 · shared-events 4 · observability 1) · `cargo fmt --all --check` ✅ · gated tests (booking outbox/IDOR · trv · otp lifecycle · profile upsert/approve · gateway pipeline) ผ่านกับ PG+Redis จริง
